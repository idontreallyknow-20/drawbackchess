...
export default function Error(props: { error: Error & { digest?: string }; retry: () => void }) {
  return (
    <RouteError
      ...
      detail="The lobby failed to render. If you were in the pairing queue, it was dropped when the page broke, so join it again after retrying."
